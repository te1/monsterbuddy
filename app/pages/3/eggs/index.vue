<script lang="ts" setup>
  ...
  definePageMeta({
    sidebarComponent: S3EggSidebar,
  });

  useSeoMeta({
    title: `Egg List For ${gameTypeToFullLabel('mhst3')}`,
    description:
...
<template>
  <div>
    ...
    >
      ...
      <S3MonsterNoResults v-if="eggFilter.isEmpty && !showEggFinder">
        No eggs found
      </S3MonsterNoResults>
    </UPageBody>
    ...
    <ClientOnly>
      ...
      >
        <template #body>
          <S3MonsterViewOptions :filter="eggFilter" :modes="modes" modalLayout />
