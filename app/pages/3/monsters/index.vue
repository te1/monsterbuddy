<script lang="ts" setup>
  ...
  const showActiveFilters = computed(
    () => monsterFilter.hasActiveSort || monsterFilter.hasActiveFilters
  );
...
<template>
  <div>
    ...
    <UPageBody :class="{ '-mt-3 lg:mt-0': monsterFilter.isGrouped || showActiveFilters }">
      ...
      >
        <div class="flex flex-wrap items-center justify-center gap-2">
          <AppFilterPill
            ...
            filterTarget="/3/monsters?filter"
      ...
      <S3MonsterNoResults v-if="monsterFilter.isEmpty">No monsters found</S3MonsterNoResults>
    </UPageBody>
    ...
    <ClientOnly>
      ...
      >
        <template #body>
          <S3MonsterViewOptions :filter="monsterFilter" :modes="modes" modalLayout />
